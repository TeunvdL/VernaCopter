...
pars.GPT_model = "gpt-4o"                                   # GPT model to use ("gpt-4o", "gpt-3.5-turbo")
pars.spec_checker_enabled = True                            # Enable the specification checker
pars.syntax_checker_enabled = True                          # Enable the syntax checker
